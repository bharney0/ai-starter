...
import { useLogin, getToken, isLoggedIn, requireAccessControl } from "../../auth/authConfig";
...
const Chat = () => {
    ...
    const getConfig = async () => {
        // const config = configApi()
				setShowGPT4VOptions(false);
				setUseSemanticRanker(true);
				setShowSemanticRankerOption(true);
