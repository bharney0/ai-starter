...
export const actionCreators = {
    ...
    sendAlert: (message: React.ReactNode | string, alertType: AlertType, autoClose: boolean): ThunkDispatch<AlertState, any, KnownAction> => {
...
export const reducer: Reducer<AlertState> = (state: AlertState|undefined, incomingAction: Action) => {
    if (state === undefined) {
