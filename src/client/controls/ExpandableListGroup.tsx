...
export class ExpandableListGroup extends React.Component<ExpandablePanelProps, {}> {
	...
	public render() {
		return (
			<div key={`sliderAccordion ${this.props.id}`} className="panel-group" id="sliderAccordion">
				<a
				...
				>
					...
					<FontAwesomeIcon
						...
						size="1x"
						style={{ verticalAlign: '-0.2em', marginLeft: '8px' }}
						icon={this.state.active ? faCaretDown : faCaretRight}
					/>
				</a>
				<div
